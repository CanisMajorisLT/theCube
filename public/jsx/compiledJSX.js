...
/***/ function(module, exports, __webpack_require__) {
	...
	var Examples = __webpack_require__(158);
	var examplesData = __webpack_require__(160);

	__webpack_require__(169);

	var PageWrap = React.createClass({displayName: "PageWrap",
	    ...
	    render: function () {
	        return (
	            React.createElement("div", {className: "components-wrap"}, 
	                React.createElement(Menu, {goToExample: this.goToExample, data: this.props.data, active: this.state.displayExample.id}), 
	                React.createElement(Examples, {data: this.state.displayExample})
	            )
	...
	React.render(React.createElement(PageWrap, {data: examplesData}), document.getElementById('react-container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Menu = module.exports = React.createClass({displayName: "module.exports",
	    render: function () {
	        var titles = Object.keys(this.props.data).map(function (key) {
	            var active = this.props.active === this.props.data[key].id;
	            return React.createElement(MenuItem, {active: active, goToExample: this.props.goToExample, title: this.props.data[key].menuTitle, themeKey: key})
	        }.bind(this));
	        return (
	...
	render: function () {
	    ...
	    return (
	        React.createElement("div", {className: clsName, onClick: this.props.goToExample.bind(null, this.props.themeKey)}, "- ", this.props.title)
	    )
	}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
	    ...
	    render: function () {
	        ...
	        return (
	            React.createElement("div", {className: "examples-container"}, 
	                React.createElement("h2", null, this.props.data.title), 
	                React.createElement("content", null, 
	                    React.createElement("div", {className: "explanation", dangerouslySetInnerHTML: {__html: marked(this.props.data.explanation)}}), 
	                    React.createElement("div", {id: "cube-container"}), 
	                    React.createElement("div", {className: "bottomText", dangerouslySetInnerHTML: {__html: marked(this.props.data.bottomText)}})
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CubeFlat = __webpack_require__(162);
	var Cube3D = __webpack_require__(166);
	var AdaptiveCube = __webpack_require__(167);

	var Video = __webpack_require__(161);
	var StaticImage = __webpack_require__(168);
	...
	module.exports = {
	    'welcome': {
	        ...
	        initialize: function (parentDiv) {
	            ...
	            var autorotateOptions = {
	                blueprint: [['up', 4, 2000], 1, ['right', 5, 1500], 2, ['left', 8, 2500]],
	    ...
	    'userInteraction': {
	        ...
	        initialize: function (parentDiv) {
	            ...
	            Cube300x300x300_leftRight.interaction.addSwipeRotate('leftRight');
	            Cube300x300x300_upDown.interaction.addMiddleScrollRotate('upDown');
	            Cube300x300x300_upDown.interaction.addSwipeRotate('upDown');

	            var autorotateOptions = {
	                blueprint: [['up', 4, 2000], 1, ['right', 5, 1500]],
	                options: {repeat: true, repeatInterval: 10}
	            };
	            ...
	            this.cubes = [[Cube300x300x300_leftRight, 'Will rotate left/right on mouse wheel or swipe', "\n```\nvar Cube300x300x300_leftRight = new Cube3D(300, 300, 300);\n\nCube300x300x300_leftRight.interaction.addMiddleScrollRotate('leftRight');\nCube300x300x300_leftRight.interaction.addSwipeRotate('leftRight');\n```"],
	                [Cube300x300x300_upDown, 'Will rotate up/down on mouse wheel or swipe', "\n```\nvar Cube300x300x300_upDown = new Cube3D(300, 300, 300);\n\nCube300x300x300_upDown.interaction.addMiddleScrollRotate('upDown');\nCube300x300x300_upDown.interaction.addSwipeRotate('upDown');\n\n```\n**Note:** you can only set up 'leftRight' or 'upDown'. If you add one of them, the other one is turned off (with exception to Flat Cube, which can have both of the directions turned on)."],
	                [Cube300x300x300_autoRotate, 'Will auto-rotate by specified blueprint, you can not interact with it, while it is in auto mode, but you can after it is finished (NOTE IT SHOULD BE USED VERY CAREFULLY)', "*WARNING:* if you rotate it to its **top** or **bottom** faces the position of Y axis changes, meaning that it will not rotate to left/right while one of those faces is facing user. ***So if you rotate the cube up/down make sure that it never stops at top or bottom!!!***\n\n```\nvar Cube300x300x300_autoRotate = new Cube3D(300, 300, 300);\n\nvar autorotateOptions = {\n    blueprint: [['up', 3, 2000], 1, ['right', 5, 1500]],\n    options: {repeat: true, repeatInterval: 10}\n};\n\nCube300x300x300_autoRotate.interaction.addAutorotateBlueprint(autorotateOptions);\nCube300x300x300_autoRotate.interaction.addMiddleScrollRotate('leftRight');\n```"]];
	    ...
	    'flatCube': {
	        ...
	        menuTitle: 'Flat Cube',
	        explanation: "CubeFlat(height, width) implement a **pseudo** 3D cube (because it's square/rectangle that has 6 faces, which rotate in a same way as cube). It has **mostly the same api** as Cube3D, but it doesn't use any of CSS3 transformations, so it can be displayed in browsers that have no support for CSS3 transformations (you can open this in IE it should *mostly* work).",
	        bottomText: '',
	        initialize: function (parentDiv) {
	            ...
	            Cube300x300_leftRight.interaction.addSwipeRotate('leftRight');
	            Cube300x300_leftRight.interaction.addSwipeRotate('upDown');
	            var Cube300x300_upDown = new CubeFlat(300, 300);
	            Cube300x300_upDown.interaction.addMiddleScrollRotate('upDown');
	            Cube300x300_upDown.interaction.addSwipeRotate('leftRight');
	            Cube300x300_upDown.interaction.addSwipeRotate('upDown');
	            ...
	            Cube300x300_autoRotate.interaction.addAutorotateBlueprint({
	                blueprint: [['left', 4, 2500], 1, ['down', 4, 2000], ['right', 6, 1500]],
	                options: {repeat: true, repeatInterval: 20}
	            });
	            Cube300x300_autoRotate.interaction.addSwipeRotate('leftRight');
	            Cube300x300_autoRotate.interaction.addSwipeRotate('upDown');
	            // Create a video which autoplays when is on front (facing user)
	            var vid1 = new Video({
	                url: 'video/big-buck-bunny_trailer.webm',
	                controls: false,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Face = __webpack_require__(163);
	var CubeInteraction = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.push([module.id, "* {\n  box-sizing: border-box; }\n\nbody {\n  overflow-y: hidden; }\n\nhtml, body, #react-container, .components-wrap {\n  height: 100%; }\n\n#react-container {\n  min-width: 800px; }\n\n.menu {\n  font-size: 20px;\n  position: relative;\n  display: inline-block;\n  vertical-align: top;\n  width: 250px;\n  height: 100%;\n  background-color: #03A9F4; }\n  .menu div {\n    margin: 20px 5px 0 5px; }\n  .menu .active {\n    color: #fff; }\n\n.examples-container {\n  font-family: 'Roboto Condensed', sans-serif;\n  padding: 10px 15px 10px 15px;\n  position: relative;\n  width: calc(100% - 250px);\n  height: 100%;\n  background-color: #fff;\n  display: inline-block;\n  overflow-x: hidden; }\n\n#cube-container {\n  margin-top: 30px; }\n  #cube-container .perspective-wrap, #cube-container .cube-flat {\n    margin: 45px auto; }\n  #cube-container h3 {\n    margin-top: 50px; }\n\n.explanation, .cube-container-text-body, .bottomText {\n  margin: 0 15px 0 15px; }\n", ""]);
